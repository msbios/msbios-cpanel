...
$(function() {
    ...
    $("#alpaca-option-tree-connector").alpaca({
        "schemaSource": "/limitless/assets/demo_data/alpaca/optiontree-custom-schema.json",
        "optionsSource": "/limitless/assets/demo_data/alpaca/optiontree-custom-options.json",
        "options": {
            "focus": false
        }
    });
