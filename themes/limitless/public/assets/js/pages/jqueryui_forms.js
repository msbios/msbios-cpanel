...
$(function() {
    ...
    $("#ac-remote").autocomplete({
        minLength: 2,
        source: "/limitless/assets/demo_data/jquery_ui/autocomplete.php",
        search: function() {
    ...
    $("#ac-caching").autocomplete({
        ...
        source: function(request, response) {
            ...
            $.getJSON("/limitless/assets/demo_data/jquery_ui/autocomplete.php", request, function(data, status, xhr) {
                cache[ term ] = data;
                response(data);
            });
        },
